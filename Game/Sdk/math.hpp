...
//}
//
//FRotator Math::NormalizeAxis(FRotator Rotation) {
...
//float GetDegreeDistance(FRotator Rotator1, FRotator Rotator2) {
//	FVector ForwardVector1 = SDK::UKismetMathLibrary::GetForwardVector(Rotator1);
//	FVector ForwardVector2 = SDK::UKismetMathLibrary::GetForwardVector(Rotator2);
//
...
//
//	InterpolatedValue = clamp(InterpolatedValue, MinValue, MaxValue);
//
